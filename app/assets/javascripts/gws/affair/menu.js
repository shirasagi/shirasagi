globalThis.Gws_Affair_Menu = (function () {
  function Gws_Affair_Menu(current, sessionKey) {
  ...
  Gws_Affair_Menu.prototype.updateSession = function () {
    var navi = $(".narrow-page[data-navi].show").map(function () {
      return $(this).attr("data-navi")
    }).toArray();
