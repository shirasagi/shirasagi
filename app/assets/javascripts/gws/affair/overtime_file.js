globalThis.Gws_Affair_OvertimeFile = (function () {
  function Gws_Affair_OvertimeFile(options) {
  ...
  Gws_Affair_OvertimeFile.prototype.compensatoryFormAlert = function (e) {
    ...
    }).text(i18next.t("gws/affair.links.ignore_and_save")));
    footer.append($('<button/>', {
      name: "button",
      type: "button",
      class: "btn-default cancel"
    }).text(i18next.t("gws/affair.links.back_to_form")));
    $.colorbox({
  ...
  return Gws_Affair_OvertimeFile;
})();
