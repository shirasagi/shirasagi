...
globalThis.Cms_Column_Select_Page = (function () {
  function Cms_Column_Select_Page(el) {
    this.$el = $(el);
  }
  ...
  Cms_Column_Select_Page.prototype.render = function () {
    ...
    self.$el.find(".ajax-box").data("on-select", function ($item) {
      ...
      var tr = ejs.render(Cms_Column_Select_Page.defaultTemplate, {
        data: $data[0].dataset,
