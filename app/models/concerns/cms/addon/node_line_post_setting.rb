module Cms::Addon::NodeLinePostSetting
  ...
  included do
    field :node_line_poster_state, type: String
    field :node_line_auto_post, type: String
    field :node_line_post_format, type: String
    field :node_line_edit_auto_post, type: String
    permit_params :node_line_poster_state, :node_line_auto_post, :node_line_post_format, :node_line_edit_auto_post
  end

  def node_line_poster_state_options
  ...
  def node_line_poster_enabled?
    node_line_poster_state != 'expired'
  end
end
