module Gws::Member
  ...
  def overall_members_was
    user_ids_was = (member_ids_was.presence || member_ids_previously_was).to_a
    group_ids_was = (member_group_ids_was.presence || member_group_ids_previously_was).to_a

    if self.class.member_include_custom_groups?
      custom_group_ids_was = (member_custom_group_ids_was.presence || member_custom_group_ids_previously_was).to_a
      member_custom_groups_was = Gws::CustomGroup.site(cur_site || site).in(id: custom_group_ids_was)
