module Gws::Addon::System::MenuSetting
  ...
  included do
    %w(portal reminder presence schedule todo attendance bookmark memo board faq qna report workflow circular monitor
       share shared_address personal_address staff_record links discussion contrast).each do |name|
