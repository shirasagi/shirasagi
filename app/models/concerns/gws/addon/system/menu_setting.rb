module Gws::Addon::System::MenuSetting
  ...
  included do
    ...
    field :menu_attendance_state, type: String, default: 'show'
    field :menu_attendance_label, type: String, localize: true
  ...
  alias menu_attendance_state_options menu_state_options
  ...
  def menu_attendance_visible?
    menu_attendance_state == 'show'
  end
