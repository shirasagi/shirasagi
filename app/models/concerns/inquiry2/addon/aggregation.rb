module Inquiry2::Addon
  module Aggregation
    ...
    def aggregate_select_columns(params = {})
      ...
      aggregation = Inquiry2::Answer.collection.aggregate(pipes)
    ...
    def aggregate_for_list(params = {})
      ...
      Inquiry2::Answer.collection.aggregate(pipes)
    end
    ...
    def build_match_stage(params = {})
      ...
      if params[:user].present?
        match["_id"] = { "$in" => Inquiry2::Answer.site(params[:site]).allow(:read, params[:user]).pluck(:id) }
      end
