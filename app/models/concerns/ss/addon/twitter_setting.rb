module SS::Addon::TwitterSetting
  ...
  included do
    ...
    permit_params :twitter_card, :twitter_username, :twitter_default_image_url, :twitter_consumer_key, :twitter_consumer_secret, :twitter_access_token, :twitter_access_token_secret
  end
