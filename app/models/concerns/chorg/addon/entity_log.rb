module Chorg::Addon::EntityLog
  ...
  def entity_log_path
    "#{SS::File.root}/chorg_tasks/" + SS::FilenameUtils.dirname_with_id(id) + "/_/entity_logs.log"
  end

  def entity_sites_path
    "#{SS::File.root}/chorg_tasks/" + SS::FilenameUtils.dirname_with_id(id) + "/_/entity_sites.log"
  end
