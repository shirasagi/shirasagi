...
class Webmail::Mail
  ...
  def save_rfc822
    ...
    ::File.binwrite rfc822_path, rfc822
  end

  def read_rfc822
    self.rfc822 = ::File.exists?(rfc822_path) ? ::File.binread(rfc822_path) : nil
  end

  def destroy_rfc822
    ::FileUtils.rm_rf(rfc822_path) if ::File.exists?(rfc822_path)
  end
end
