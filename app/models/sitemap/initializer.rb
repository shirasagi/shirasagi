module Sitemap
  class Initializer
    ...
    Cms::Role.permission :close_other_sitemap_pages
    Cms::Role.permission :close_private_sitemap_pages
    ...
    Cms::Role.permission :revoke_other_sitemap_pages
    Cms::Role.permission :revoke_private_sitemap_pages
  end
end
