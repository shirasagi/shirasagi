class Jmaxml::Renderer::Landslide < Jmaxml::Renderer::Base
  ...
  private
    def title_template
      I18n.t('jmaxml.templates.landslide.title')
    end

    def upper_html_template
      I18n.t('jmaxml.templates.landslide.upper_html')
    end

    def loop_html_template
      I18n.t('jmaxml.templates.landslide.loop_html')
    end

    def lower_html_template
      I18n.t('jmaxml.templates.landslide.lower_html')
    end
