class Jmaxml::Renderer::Quake < Jmaxml::Renderer::Base
  ...
  private
    def title_template
      I18n.t('jmaxml.templates.quake.title')
    end

    def upper_html_template
      I18n.t('jmaxml.templates.quake.upper_html')
    end

    def loop_html_template
      I18n.t('jmaxml.templates.quake.loop_html')
    end
