module Gws::Schedule
  class Initializer
    ...
    Gws::Role.permission :approve_private_gws_schedule_plans, module_name: 'gws/schedule'
    Gws::Role.permission :approve_other_gws_schedule_plans, module_name: 'gws/schedule'
    Gws::Role.permission :reroute_private_gws_schedule_plans, module_name: 'gws/schedule'
    Gws::Role.permission :reroute_other_gws_schedule_plans, module_name: 'gws/schedule'
