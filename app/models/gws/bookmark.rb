class Gws::Bookmark
  ...
  BOOKMARK_MODEL_TYPES = %w(
    portal notice schedule schedule/todo reminder presence memo bookmark attendance report workflow circular monitor survey
    board faq qna discussion share shared_address personal_address elasticsearch staff_record
  ).freeze
