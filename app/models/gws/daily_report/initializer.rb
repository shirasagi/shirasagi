module Gws::DailyReport
  class Initializer
    ...
    Gws::Role.permission :access_private_gws_daily_report_reports, module_name: 'gws/daily_report'
    Gws::Role.permission :access_all_gws_daily_report_reports, module_name: 'gws/daily_report'
