...
class Gws::Workflow2::FileEnumerator < Enumerator
  ...
  def build_term_handlers
    ...
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_id"), handler: method(:to_user_id), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_name_ja"), handler: method(:to_user_name_ja), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_name_en"), handler: method(:to_user_name_en), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_group_ja"), handler: method(:to_user_group_ja), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_group_en"), handler: method(:to_user_group_en), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.user_email"), handler: method(:to_user_email), type: :base }
    ...
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_id"), handler: method(:to_agent_id), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_name_ja"), handler: method(:to_agent_name_ja), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_name_en"), handler: method(:to_agent_name_en), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_group_ja"), handler: method(:to_agent_group_ja), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_group_en"), handler: method(:to_agent_group_en), type: :base }
    @handlers << { name: I18n.t("gws/workflow2.table.gws/workflow2/file.agent_email"), handler: method(:to_agent_email), type: :base }
  end
  ...
  def to_user_name_ja(item)
    find_workflow_user_custom_data_value(item, "i18n_name_ja")
  end

  def to_user_name_en(item)
    find_workflow_user_custom_data_value(item, "i18n_name_en")
  end

  def to_user_group_ja(item)
    find_workflow_user_custom_data_value(item, "i18n_section_name_ja")
  end

  def to_user_group_en(item)
    find_workflow_user_custom_data_value(item, "i18n_section_name_en")
  end
  ...
  def to_agent_name_ja(item)
    find_workflow_agent_custom_data_value(item, "i18n_name_ja")
  end

  def to_agent_name_en(item)
    find_workflow_agent_custom_data_value(item, "i18n_name_en")
  end

  def to_agent_group_ja(item)
    find_workflow_agent_custom_data_value(item, "i18n_section_name_ja")
  end

  def to_agent_group_en(item)
    find_workflow_agent_custom_data_value(item, "i18n_section_name_en")
  end
