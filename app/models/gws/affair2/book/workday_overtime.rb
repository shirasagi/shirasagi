class Gws::Affair2::Book::WorkdayOvertime < Gws::Affair2::Book::Overtime::Base
  include Gws::SitePermission

  set_permission_name "gws_affair2_workday_overtime_books"
  ...
  def load(site, user, date, group)
    ...
    @files = Gws::Affair2::Overtime::WorkdayFile.site(site).user(user).and([
  ...
  def title
    I18n.t("gws/affair2.book.overtime.workday_title", year: year, month: month)
  end
