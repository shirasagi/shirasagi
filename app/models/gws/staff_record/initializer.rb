module Gws::StaffRecord
  class Initializer
    ...
    Gws::Role.permission :read_other_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
    Gws::Role.permission :read_private_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
    Gws::Role.permission :edit_other_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
    Gws::Role.permission :edit_private_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
    Gws::Role.permission :delete_other_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
    Gws::Role.permission :delete_private_gws_staff_record_user_occupations, module_name: 'gws/staff_record'
