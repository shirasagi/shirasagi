class Gws::Affair::Enumerator::User::Over < Gws::Affair::Enumerator::Base
  ...
  def set_record(yielder, user)
    duty_day_time_minute = @prefs.dig(user.id, @capital_basic_code, "over_threshold", "duty_day_time_minute")
    duty_night_time_minute = @prefs.dig(user.id, @capital_basic_code, "over_threshold", "duty_night_time_minute")
    leave_day_time_minute = @prefs.dig(user.id, @capital_basic_code, "over_threshold", "leave_day_time_minute")
    leave_night_time_minute = @prefs.dig(user.id, @capital_basic_code, "over_threshold", "leave_night_time_minute")
    week_out_compensatory_minute = @prefs.dig(user.id, @capital_basic_code, "over_threshold", "week_out_compensatory_minute")
