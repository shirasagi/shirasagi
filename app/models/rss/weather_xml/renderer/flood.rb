class Rss::WeatherXml::Renderer::Flood < Rss::WeatherXml::Renderer::Base
  ...
  private
    def title_template
      I18n.t('rss.templates.flood.title')
    end

    def upper_html_template
      I18n.t('rss.templates.flood.upper_html')
    end

    def loop_html_template
      I18n.t('rss.templates.flood.loop_html')
    end

    def lower_html_template
      I18n.t('rss.templates.flood.lower_html')
    end
