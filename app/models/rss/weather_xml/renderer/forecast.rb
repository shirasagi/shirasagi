class Rss::WeatherXml::Renderer::Forecast < Rss::WeatherXml::Renderer::Base
  ...
  private
    def title_template
      I18n.t('rss.templates.forecase.title')
    end

    def upper_html_template
      I18n.t('rss.templates.forecase.upper_html')
    end

    def loop_html_template
      I18n.t('rss.templates.forecase.loop_html')
    end

    def lower_html_template
      I18n.t('rss.templates.forecase.lower_html')
    end
