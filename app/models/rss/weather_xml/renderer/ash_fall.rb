class Rss::WeatherXml::Renderer::AshFall < Rss::WeatherXml::Renderer::Base
  ...
  private
    def title_template
      I18n.t('rss.templates.ash_fall.title')
    end

    def upper_html_template
      I18n.t('rss.templates.ash_fall.upper_html')
    end

    def loop_html_template
      I18n.t('rss.templates.ash_fall.loop_html')
    end

    def lower_html_template
      I18n.t('rss.templates.ash_fall.lower_html')
    end
