module Cms::ListHelper
  ...
  def render_list_with_shirasagi(cur_item, default_loop_html, &block)
    ...
    if block
      ...
      if cur_item.loop_setting.present? && cur_item.loop_setting.state == "public" && cur_item.loop_setting.html_format == "SHIRASAGI" && cur_item.loop_setting.custom_html.present?
