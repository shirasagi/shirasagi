...
json.usage_node_count_html @cur_site.usage_node_count.try { |v| v.to_fs(:delimited) } || '-'
json.usage_page_count_html @cur_site.usage_page_count.try { |v| v.to_fs(:delimited) } || '-'
