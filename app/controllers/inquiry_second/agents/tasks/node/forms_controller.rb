class InquirySecond::Agents::Tasks::Node::FormsController < ApplicationController
  include Cms::PublicFilter::Node

  def generate_inquiry_second_node(node, opts = {})
  ...
  def generate
    ...
    if generate_inquiry_second_node @node
