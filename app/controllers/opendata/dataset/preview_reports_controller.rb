class Opendata::Dataset::PreviewReportsController < ApplicationController
  include Cms::BaseFilter

  model Opendata::DatasetPreviewReport
  ...
  def download
    ...
    send_enum @item.enum_csv, type: 'text/csv; charset=Shift_JIS',
      filename: "dataset_preview_report_#{Time.zone.now.to_i}.csv"
  end
end
