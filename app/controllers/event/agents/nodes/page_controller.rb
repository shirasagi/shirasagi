class Event::Agents::Nodes::PageController < ApplicationController
  ...
  def monthly
    ...
    @window_name = "#{@cur_node.name} - #{I18n.l date, format: :long_month} - " if @window_name.blank?
  ...
  def daily
    ...
    @cur_site.window_name = "#{@cur_node.name} - #{I18n.l date, format: :long} - "
