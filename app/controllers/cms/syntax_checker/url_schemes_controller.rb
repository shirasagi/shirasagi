class Cms::SyntaxChecker::UrlSchemesController < ApplicationController
  ...
  def get_params
    params.require(:item).permit(:syntax_checker_url_scheme_attributes, :syntax_checker_url_scheme_schemes)
  rescue
    raise "400"
  end
