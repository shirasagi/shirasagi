class Gws::Affair::Attendance::Apis::Management::UsersController < ApplicationController
  ...
  def set_manageable_groups
    @manageable_groups ||= begin
      if Gws::Attendance::TimeCard.allowed?(:manage_all, @cur_user, site: @cur_site, permission_name: module_name)
        Gws::Group.in_group(@cur_site).active
      elsif Gws::Attendance::TimeCard.allowed?(:manage_private, @cur_user, site: @cur_site, permission_name: module_name)
