class Gws::Affair::Overtime::Aggregate::SearchUsersController < ApplicationController
  ...
  def set_crumbs
    ...
    @crumbs << [t("modules.gws/affair/overtime/aggregate"), gws_affair_overtime_aggregate_search_users_main_path]
    @crumbs << [t("modules.gws/affair/overtime/aggregate/search_users"), gws_affair_overtime_aggregate_search_users_main_path]
  end
