class Gws::Affair2::Overtime::AchieveController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter
  include Gws::Affair2::BaseFilter

  model Gws::Affair2::Overtime::Achieve
  ...
  def set_crumbs
    ...
    @crumbs << [ t("modules.gws/affair2/overtime/achieve"), action: :index ]
  end
