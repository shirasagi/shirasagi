class Gws::Affair2::Book::HolidayOvertimeController < ApplicationController
  ...
  model Gws::Affair2::Book::HolidayOvertime
  ...
  def set_crumbs
    ...
    @crumbs << [ t("modules.gws/affair2/book/holiday_overtime"), action: :index ]
  end
