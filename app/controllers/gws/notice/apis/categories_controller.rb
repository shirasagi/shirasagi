class Gws::Notice::Apis::CategoriesController < ApplicationController
  ...
  def set_category
    @categories = Gws::Notice::Category.site(@cur_site).readable(@cur_user, site: @cur_site).tree_sort
