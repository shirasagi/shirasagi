class Gws::Questionnaire::Apis::CategoriesController < ApplicationController
  include Gws::ApiFilter

  model Gws::Questionnaire::Category
  ...
  def set_category
    @categories = Gws::Questionnaire::Category.site(@cur_site).readable(@cur_user, site: @cur_site).tree_sort
