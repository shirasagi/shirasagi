class Gws::Questionnaire::EditablesController < ApplicationController
  ...
  model Gws::Questionnaire::Form

  navi_view "gws/questionnaire/main/navi"

  append_view_path "app/views/gws/questionnaire/main"
  ...
  def set_categories
    @categories ||= Gws::Questionnaire::Category.site(@cur_site).readable(@cur_user, site: @cur_site)
  end
