class Gws::Report::Apis::CategoriesController < ApplicationController
  ...
  def set_category
    @categories = Gws::Report::Category.site(@cur_site).readable(@cur_user, site: @cur_site).tree_sort
