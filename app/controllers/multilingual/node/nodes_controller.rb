class Multilingual::Node::NodesController < ApplicationController
  include Cms::BaseFilter
  include Cms::NodeFilter

  navi_view "cms/main/navi"
  lang_view "multilingual/nodes/lang"
  ...
  private
    ...
    def set_native_item
      @native_item = Cms::Node.find(params[:native_id]).becomes_with_route
    end
