class Rss::WeatherXml::FloodRegionsController < ApplicationController
  include Cms::BaseFilter
  include Cms::CrudFilter

  model Rss::WeatherXml::FloodRegion
  ...
  public
    ...
    def download
      ...
      filename = "flood_regions_#{Time.zone.now.to_i}.csv"
      response.status = 200
    ...
    def import
      ...
      job_class = Rss::WeatherXml::FloodRegionImportJob
