class Rss::WeatherXml::ForecastRegionsController < ApplicationController
  include Cms::BaseFilter
  include Cms::CrudFilter

  model Rss::WeatherXml::ForecastRegion
  ...
  public
    ...
    def download
      ...
      response.status = 200
      send_enum SS::CsvConverter.enum_csv(@items, %w(code name yomi short_name short_yomi order state)),
    ...
    def import
      ...
      job_class = Rss::WeatherXml::ForecastRegionImportJob
