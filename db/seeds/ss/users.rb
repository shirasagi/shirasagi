...
sys = save_user(
  { name: "システム管理者", uid: "sys", email: "sys@example.jp", in_password: "pass", kana: "システムカンリシャ" },
  {
    ...
    group_ids: [g11.id], sys_role_ids: [sys_r01.id],
...
adm = save_user(
  ...
  {
    type: SS::User::TYPE_SNS,
    group_ids: [g11.id], sys_role_ids: [sys_r02.id],
...
u02 = save_user(
  ...
  {
    type: SS::User::TYPE_SNS,
    group_ids: [g21.id], sys_role_ids: [sys_r02.id],
...
u05 = save_user(
  ...
  {
    type: SS::User::TYPE_SNS,
    group_ids: [g12.id], sys_role_ids: [sys_r02.id],
