          ...
          var options = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    vwrap = $('.vwrap');
//                    core = '<div class="vbox-overlay" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close"><span style="font-family:icomoon;font-weight: normal;" class="f18 pr5">&#xe67b;</span>閉じる</div><div class="vbox-next">next</div><div class="vbox-prev">prev</div></div>';
                    core = '<div class="vbox-overlay" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-close"><span style="font-family:icomoon;font-weight: normal;" class="f18 pr5">&#xe67b;</span>閉じる</div><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-next">next</div><div class="vbox-prev">prev</div></div>';
...
//                    $('.vbox-close, .vbox-overlay').click(function(e){
    ...
    /* -------- CENTER ON LOAD -------- */
    function updateoverlay(notopzero, fulsize){
      notopzero = notopzero || false;
      fulsize = fulsize || false;
      if (notopzero != true) {
        $(window).scrollTop(0);
      }
