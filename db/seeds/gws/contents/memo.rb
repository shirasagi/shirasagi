...
# file_1 = new_ss_files "db/seeds/gws/files/file.pdf", cur_user: u("user1"), filename: "file2.pdf", model: "ss/temp_file", state: "closed"
...
new_ss_files("db/seeds/gws/files/file.pdf", cur_user: u("user1"), filename: "file2.pdf", model: "ss/temp_file", state: "closed").tap do |file|
create_message(
...
new_ss_files("db/seeds/gws/files/file.pdf", cur_user: u("user2"), filename: "file2.pdf", model: "ss/temp_file", state: "closed").tap do |file|
create_message(
