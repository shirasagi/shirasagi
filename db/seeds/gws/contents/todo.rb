...
@todos = [
  create_schedule_todo(
    ...
    start_at: @now + 7.days, end_at: @now + 7.days + 1.hour, priority: '1',
    repeat_type: "monthly", interval: "1", repeat_base: "wday", wdays: [""],
    repeat_start: @now.beginning_of_month, repeat_end: (@now + 8.months).end_of_month,
    todo_state: 'unfinished', discussion_forum_id: @ds_forums[0].id
  ),
  create_schedule_todo(
    name: '防災年間スケジュール作成', member_ids: [u('user4').id],
    start_at: third_thursday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'),
    end_at: third_thursday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'), priority: '1',
    todo_state: 'unfinished', readable_setting_range: 'select',
    readable_member_ids: [u('user4').id]
  ),
  create_schedule_todo(
    name: '地域防災計画資料見直し', member_ids: [u('user2').id],
    start_at: forth_monday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'),
    end_at: forth_monday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'), priority: '1',
    todo_state: 'unfinished', readable_setting_range: 'select',
    readable_member_ids: [u('user2').id]
  ),
  create_schedule_todo(
    name: '会議資料作成', member_ids: [u('user1').id],
    start_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 16:00'),
    end_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 16:00'), priority: '1',
    todo_state: 'unfinished', readable_setting_range: 'select',
  ...
  create_schedule_todo(
    ...
    start_at: first_monday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'),
    end_at: first_monday_of_month(base_date + 4.months).strftime('%Y-%m-%d 17:00'), priority: '1',
    todo_state: 'unfinished', readable_setting_range: 'select',
  ...
  create_schedule_todo(
    ...
    start_at: first_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 18:24'),
    end_at: first_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 19:24'), priority: '1',
    todo_state: 'finished', readable_setting_range: 'select',
    readable_member_ids: [u('user1').id]
  ),
  create_schedule_todo(
    cur_user: u("sys"), name: 'イベント資料作成', member_ids: [u('sys').id],
    start_at: forth_friday_of_month(base_date + 3.months).strftime('%Y-%m-%d 13:00'),
    end_at: forth_friday_of_month(base_date + 3.months).strftime('%Y-%m-%d 13:00'),
  ...
  create_schedule_todo(
    ...
    end_at: second_thursday_of_month(base_date + 3.months).strftime('%Y-%m-%d 18:00'), priority: '2',
    todo_state: 'unfinished', readable_setting_range: 'select',
    readable_member_ids: [u('user3').id]
  ),
  create_schedule_todo(
  ...
  create_schedule_todo(
    ...
    start_at: third_monday_of_month(base_date + 3.months).strftime('%Y-%m-%d 13:00'),
    end_at: third_monday_of_month(base_date + 3.months).strftime('%Y-%m-%d 13:00'), priority: '3',
    todo_state: 'unfinished', readable_setting_range: 'select',
    readable_member_ids: [u('user2').id]
  ),
  create_schedule_todo(
    name: 'テレビ広報原稿作成', member_ids: [u('user3').id], cur_user: u("user3"),
    start_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 17:00'),
    end_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 17:00'), priority: '1',
    repeat_plan_id: '5b04f29f66630c8f37e5bf27',
    todo_state: 'unfinished', readable_setting_range: 'select',
    readable_member_ids: [u('user3').id]
  ),
  create_schedule_todo(
    ...
    start_at: third_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 16:00'),
    end_at: third_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 16:00'), priority: '3',
    repeat_plan_id: '5b04f29f66630c8f37e5bf27',
    todo_state: 'unfinished', readable_setting_range: 'select',
  ...
  create_schedule_todo(
    ...
    start_at: second_friday_of_month(base_date + 2.months).strftime('%Y-%m-%d 12:00'),priority: '3',
    end_at: second_friday_of_month(base_date + 2.months).strftime('%Y-%m-%d 12:00'),
  ...
  create_schedule_todo(
    ...
    start_at: first_wednesday_of_month(base_date + 2.months).strftime('%Y-%m-%d 16:00'),
    end_at: first_wednesday_of_month(base_date + 2.months).strftime('%Y-%m-%d 17:00'),
  ...
  create_schedule_todo(
    ...
    start_at: first_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 18:30'),
    end_at: first_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 19:30'),
    repeat_plan_id: '5b04f29f66630c8f37e5bf27',
  ...
  create_schedule_todo(
    name: '[サイト改善プロジェクト]要求仕様提出', member_ids:  [u('admin').id, u('user1').id, u('user2').id,
                                                           u('user4').id, u('user5').id,u('user3').id],
    start_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 17:00'),
    end_at: forth_monday_of_month(base_date + 2.months).strftime('%Y-%m-%d 17:00'),
    todo_state: 'finished', discussion_forum_id: @ds_forums[0].id, state: 'public',
    readable_setting_range: 'select',
    readable_member_ids: [u('sys').id]
  ),
