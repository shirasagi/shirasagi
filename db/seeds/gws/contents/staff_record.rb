...
@staff_record_years = [
  ...
  create_staff_record_user(
    year_id: year.id, section_name: sections[0].name, in_title_id: user_titles[1].id,
  ...
  create_staff_record_user(
    year_id: year.id, section_name: sections[0].name,
    name: "鈴木 茂", kana: 'スズキ シゲル', code: '102', charge_name: '庶務担当',
    divide_duties: "出張・研修関係\n文書収受",
    tel_ext: '0000', charge_address: @site.name, charge_tel: '0000-00-0000'
  )
  create_staff_record_user(
    year_id: year.id, section_name: sections[1].name,
