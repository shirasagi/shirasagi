...
save_page route: "article/page", filename: "docs/page29.html", name: "シラサギ博物館",
          ...
          column_values: [
            @form_columns[0].value_type.new(column: @form_columns[0], file_id: file_10.id, label: "メイン写真",
            ...
            @form_columns[10].value_type.new(column: @form_columns[10], file_id: file_10.id, label: "写真1",
                                             image_html_type: "image"),
            @form_columns[11].value_type.new(column: @form_columns[11], file_id: file_10.id, label: "写真2",
                                             image_html_type: "image"),
            @form_columns[12].value_type.new(column: @form_columns[12], file_id: file_10.id, label: "写真3",
                                             image_html_type: "image"),
            @form_columns[13].value_type.new(column: @form_columns[13], file_id: file_10.id, label: "写真4",
                                             image_html_type: "image"),
            @form_columns[14].value_type.new(column: @form_columns[14], file_id: file_10.id, label: "写真5",
                                             image_html_type: "image"),
          ],
...
save_page route: "article/page", filename: "docs/page30.html", name: "ふれあいフェスティバル開催報告",
          ...
          column_values: [
            @form_columns_2[0].value_type.new(column: @form_columns_2[0], file_id: file_10.id, label: "画像1",
                                              image_html_type: "image"),
            @form_columns_2[1].value_type.new(column: @form_columns_2[1], file_id: file_10.id, label: "画像2",
                                              image_html_type: "image"),
            @form_columns_2[2].value_type.new(column: @form_columns_2[2], file_id: file_10.id, label: "画像3",
                                              image_html_type: "image"),
...
save_page route: "article/page", filename: "docs/page31.html", name: "広報SHIRASAGI 2019年1月号",
          ...
          column_values: [
            @form_columns_3[0].value_type.new(column: @form_columns_3[0], file_id: file_11.id,
                                              label: "広報SHIRASAGI 2019年1月号   表紙", image_html_type: "image"),
            @form_columns_3[1].value_type.new(column: @form_columns_3[1], file_id: file_22.id,
                                              label: "広報SHIRASAGI 2019年1月号"),
...
save_page route: "article/page", filename: "docs/page32.html", name: "インタビュー",
          ...
          column_values: [
            ...
            @form_columns_5[0].value_type.new(column: @form_columns_5[0], order: 0, file_id: file_10.id,
                                              label: "画像", image_html_type: "image"),
            # 名前
