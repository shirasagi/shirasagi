puts "# LINE連携"
@site = Cms::Site.where(id: 1).first
...
def save_ss_files(path, data)
  puts path
  cond = { site_id: @site.id, filename: data[:filename], model: data[:model], owner_item_type: data[:owner_item_type], owner_item_id: data[:owner_item_id] }
...
# リッチメニュー画像
file = save_ss_files "ss_files/line/richmenu.png", filename: "richmenu.png", model: "cms/line/richmenu/menu", owner_item_type: "Cms::Line::Richmenu::Menu"
...
# リッチメニュー メニュー
richmenu_in_areas = [
  {"x"=>"16", "y"=>"15", "width"=>"252", "height"=>"219", "type"=>"uri", "text"=>"", "data"=>"", "uri"=>"https://#{@site.domain}", "menu_id"=>""},
  {"x"=>"276", "y"=>"14", "width"=>"248", "height"=>"222", "type"=>"postback", "text"=>"", "data"=>"チャットボット", "uri"=>"", "menu_id"=>""},
  {"x"=>"533", "y"=>"14", "width"=>"251", "height"=>"221", "type"=>"uri", "text"=>"https://#{@site.domain}/login/login.html?ref=%2Fmypage%2Fprofile%2F", "data"=>"", "uri"=>"https://#{@site.domain}/login/login.html?ref=%2Fmypage%2Fprofile%2F", "menu_id"=>""}
]
