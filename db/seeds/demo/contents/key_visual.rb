...
keyvisual8 = save_ss_files "ss_files/key-visual/keyvisual08.png", filename: "keyvisual08.png",
  model: "key_visual/image"
save_page route: "key_visual/image", filename: "key-visual/page37.html", name: "しらさぎ市のアジサイ", order: 10,
...
save_page route: "key_visual/image", filename: "key-visual/page38.html", name: "しらさぎ橋", order: 20,
  display_remarks: %w(title remark_html), remark_html: '<div class="remark">観光</div>',
  file_id: keyvisual2.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page39.html", name: "梅雨のイベント", order: 30,
...
save_page route: "key_visual/image", filename: "key-visual/page40.html", name: "しらさぎ神社", order: 40,
  display_remarks: %w(title remark_html), remark_html: '<div class="remark">観光</div>',
  file_id: keyvisual4.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page50.html", name: "しらさぎ公園", order: 50,
  display_remarks: %w(title remark_html), remark_html: '<div class="remark">観光</div>',
  file_id: keyvisual5.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page51.html", name: "しらさぎマラソン", order: 60,
...
save_page route: "key_visual/image", filename: "key-visual/page52.html", name: "スマート窓口申請", order: 70,
  display_remarks: %w(title remark_html), remark_html: '<div class="remark">お知らせ</div>',
  file_id: keyvisual7.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page53.html", name: "しらさぎ市公式LINE", order: 80,
  display_remarks: %w(title remark_html), remark_html: '<div class="remark">お知らせ</div>',
