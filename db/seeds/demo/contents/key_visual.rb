...
save_page route: "key_visual/image", filename: "key-visual/page37.html", name: "キービジュアル1", order: 10,
  file_id: keyvisual1.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page38.html", name: "キービジュアル2", order: 20,
  file_id: keyvisual2.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page39.html", name: "キービジュアル3", order: 30,
  file_id: keyvisual3.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page40.html", name: "キービジュアル4", order: 40,
  file_id: keyvisual4.id, released_type: 'same_as_updated'
save_page route: "key_visual/image", filename: "key-visual/page50.html", name: "キービジュアル5", order: 50,
