...
save_node route: "image_map/page", filename: "map-clickable", name: "シラサギ市説明マップ",
...
save_page route: "image_map/page", filename: "map-clickable/page1.html", name: "西部",
...
save_page route: "image_map/page", filename: "map-clickable/page2.html", name: "北部",
  layout_id: @layouts["category-middle"].id, coords: [310, 292, 463, 370],
  link_url: '/shisei/gaiyo/hokubu.html', area_state: 'hokubu',
  group_ids: [@g_seisaku.id]

save_page route: "image_map/page", filename: "map-clickable/page3.html", name: "南部",
