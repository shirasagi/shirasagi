...
save_page route: "facility/map", filename: "institution/shisetsu/gym/map.html", name: "map",
  map_points: [{ name: "", loc: [134.585343, 34.063525], text: "" }]
save_page route: "facility/map", filename: "institution/shisetsu/pool/map.html", name: "map",
  map_points: [{ name: "", loc: [134.586169, 34.06412], text: "" }]
...
save_page route: "facility/notice", filename: "institution/shisetsu/library/page218.html", name: "当館のご利用について",
  ...
  column_values: [
    ...
    @form_columns4[10].value_type.new(column: @form_columns4[10], lists: values[4])
  ],
  group_ids: [@g_seisaku.id]
