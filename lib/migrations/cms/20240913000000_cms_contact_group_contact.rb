...
class SS::Migration20240913000000
  ...
  def change
    each_item do |item|
      ...
      item.contact_group_name = contact.contact_group_name
      item.contact_charge = contact.contact_charge
      item.contact_tel = contact.contact_tel
      item.contact_fax = contact.contact_fax
      item.contact_email = contact.contact_email
      item.contact_postal_code = contact.contact_postal_code
      item.contact_address = contact.contact_address
