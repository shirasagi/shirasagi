Rails.application.routes.draw do
  ...
  namespace "cms", path: ".s:site/cms" do
    ...
    get "generate_nodes/:key" => "generate_nodes#index"
    post "generate_nodes" => "generate_nodes#run"
    post "generate_nodes/:key" => "generate_nodes#run"
    get "generate_pages" => "generate_pages#index"
    get "generate_pages/:key" => "generate_pages#index"
    post "generate_pages" => "generate_pages#run"
    post "generate_pages/:key" => "generate_pages#run"
