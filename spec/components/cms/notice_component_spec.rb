...
describe Cms::NoticeComponent, type: :component, dbscope: :example do
  ...
  context "without cms/notice items" do
    it do
  ...
  context "with cms/notice items" do
    let!(:notice_high1) do
      create(
        :cms_notice, cur_site: site, state: "public", notice_severity: "high", notice_target: Cms::Notice::NOTICE_TARGET_ALL,
    ...
    let!(:notice_high2_2) do
      create(
        :cms_notice, cur_site: site, state: "closed", notice_severity: "high", notice_target: Cms::Notice::NOTICE_TARGET_ALL,
        released: now - 3.hours, release_date: nil, close_date: nil)
    end
    let!(:notice_high3) do
      create(
    ...
    let!(:notice_normal1) do
      create(
        :cms_notice, cur_site: site, state: "public", notice_severity: "normal", notice_target: Cms::Notice::NOTICE_TARGET_ALL,
        released: now - 4.hours, release_date: nil, close_date: nil)
    end
    ...
    let!(:notice_normal2_2) do
      create(
        :cms_notice, cur_site: site, state: "closed", notice_severity: "normal", notice_target: Cms::Notice::NOTICE_TARGET_ALL,
        released: now - 3.hours, release_date: nil, close_date: nil)
    end
    ...
    let!(:notice_out_of_date1) do
      create(
        :cms_notice, cur_site: site, state: "public", notice_target: Cms::Notice::NOTICE_TARGET_ALL,
