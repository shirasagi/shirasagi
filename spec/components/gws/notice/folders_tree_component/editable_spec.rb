  ...
  context "usual case" do
    ...
    context "with admin" do
      ...
      it do
        ...
        expect(node_ids).to have(4).items
        expect(node_ids[0]).to eq folder2.id
        expect(node_ids[1]).to eq folder1.id
        expect(node_ids[2]).to eq folder4.id
        expect(node_ids[3]).to eq folder3.id
