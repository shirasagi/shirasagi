...
RSpec.describe SS::Migration20221206000000, dbscope: :example do
  ...
  it do
    ...
    group1.contact_groups.first.tap do |contact|
      ...
      expect(page1.contact_group_name).to eq contact.contact_group_name
      expect(page1.contact_charge).to eq contact.contact_charge
    ...
    group1.contact_groups.second.tap do |contact|
      ...
      expect(page2.contact_group_name).to eq contact.contact_group_name
      expect(page2.contact_charge).to eq contact.contact_charge
