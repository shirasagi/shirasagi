...
RSpec.describe SS::Migration20221109000000, dbscope: :example do
  ...
  before do
    ...
    group1.set(
      ...
      contact_tel: contact_tel1, contact_fax: contact_fax1, contact_email: contact_email1,
      contact_postal_code: contact_postal_code1, contact_address: contact_address1,
