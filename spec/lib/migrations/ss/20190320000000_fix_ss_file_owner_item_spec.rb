...
RSpec.describe SS::Migration20190320000000, dbscope: :example do
  ...
  let!(:file1) { tmp_ss_file(user: cms_user, site: cms_site, contents: "#{Rails.root}/spec/fixtures/ss/logo.png") }
  let!(:file2) { tmp_ss_file(user: cms_user, site: cms_site, contents: "#{Rails.root}/spec/fixtures/ss/logo.png") }
  let!(:file3) { tmp_ss_file(user: cms_user, site: cms_site, contents: "#{Rails.root}/spec/fixtures/ss/logo.png") }
  # gws
