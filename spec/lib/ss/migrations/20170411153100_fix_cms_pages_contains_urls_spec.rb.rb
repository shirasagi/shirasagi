...
RSpec.describe SS::Migration20170411153100, dbscope: :example do
  before do
    create :cms_body_layout
    create :article_page, name: "cms_page1",
      html: '<a href="/docs/">/docs/</a><a href="http://www.ss-proj.org/">http://www.ss-proj.org/</a>'
    create :cms_page, name: "cms_page2",
      html: '<img src="/fs/1/1/1/_/example.jpg">'
    create :article_page, name: "cms_page3",
      html: '<div>html</div>'
    create :article_page, name: "cms_page4",
       html: '<a href="/docs/">/docs/</a><a href="http://www.ss-proj.org/">http://www.ss-proj.org/</a>',
