...
describe "article_pages", type: :feature, dbscope: :example, js: true do
  ...
  describe "update column with entry form on preview editing" do
    let(:column1_value1_value1) { unique_id }
    let(:column1_value2_value1) { unique_id }
    let(:column1_value2_value2) { unique_id }
    let!(:item) do
      create(
    ...
    describe "update" do
      shared_examples "what update is" do
        it do
          ...
          # Update
          #
          first(:xpath, "//*[text()='#{column1_value2_value1}']").click
          ...
          page.within_frame page.first("#ss-preview-dialog-frame") do
            within "#item-form" do
              within ".column-value-cms-column-textfield" do
                fill_in "item[column_values][][in_wrap][value]", with: column1_value2_value2
              end
          ...
          expect(column_value1.value).to eq column1_value1_value1
          expect(column_value1.order).to eq 0
          column_value2 = column_values[1]
          expect(column_value2.column_id).to eq column1.id
          expect(column_value2.value).to eq column1_value2_value2
      ...
      context "with public page" do
        ...
        it_behaves_like "what update is"
      end
