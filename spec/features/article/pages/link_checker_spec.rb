...
describe "link_checker", type: :feature, dbscope: :example, js: true do
  ...
  before do
    ...
    stub_request(:any, success_url3).to_return(body: "", status: 200, headers: { 'Content-Type' => 'text/html' })
    stub_request(:any, success_url4).to_return(body: "", status: 200, headers: { 'Content-Type' => 'text/html' })
        ...
        it do
          ...
          within "form#item-form" do
            within "#addon-cms-agents-addons-body" do
              ...
              expect(page).to have_no_css('#errorLinkChecker')
            end
          end
        end
      end
