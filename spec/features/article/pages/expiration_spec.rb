...
describe "article_pages", type: :feature, dbscope: :example, js: true do
  ...
  context "when page_expiration_state is enabled but page's expiration_setting_type is never" do
    before do
      site.page_expiration_state = "enabled"
      site.page_expiration_before = %w(90.days 180.days 1.year 2.years 3.years).sample
      site.page_expiration_mail_subject = unique_id
      ...
      page1.set(expiration_setting_type: 'never')
      page2.set(expiration_setting_type: 'never')
    end
