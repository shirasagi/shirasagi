...
describe "multilingual_nodes", dbscope: :example do
  ...
  let!(:en_show_path) { multilingual_node_path site.id, native_item, lang, foreign_item }
  let!(:en_edit_path) { edit_multilingual_node_path site.id, native_item, lang, foreign_item }
  let!(:en_delete_path) { delete_multilingual_node_path site.id, native_item, lang, foreign_item }
