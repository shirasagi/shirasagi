  ...
  context "add plan" do
    ...
    it "create plan" do
      ...
      within ".gws-schedule-box" do
        expect(page).to have_link facility1.name
        expect(page).to have_no_link facility2.name
        expect(page).to have_css(".fc-event-title", text: name1)
      end
      ...
      within ".gws-schedule-box" do
        expect(page).to have_no_link facility1.name
        expect(page).to have_link facility2.name
        expect(page).to have_no_css(".fc-event-title", text: name1)
        expect(page).to have_css(".fc-event-title", text: name2)
      end
    end
