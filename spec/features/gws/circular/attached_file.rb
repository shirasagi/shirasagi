...
describe "gws_circular", type: :feature, dbscope: :example do
  context "admins attached_file", js: true do
    ...
    let(:edit_path) { edit_gws_circular_admin_path(site, item) }
