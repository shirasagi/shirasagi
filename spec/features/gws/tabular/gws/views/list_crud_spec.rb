...
describe Gws::Tabular::Gws::ViewsController, type: :feature, dbscope: :example, js: true do
  ...
  context "list type view crud" do
    ...
    it do
      ...
      within "form#item-form" do
        choose I18n.t("mongoid.models.gws/tabular/view/list")
      ...
      within "form#item-form" do
        ...
        within "[data-field-name='title_column_ids']" do
          check column1.name
        end
        within "[data-field-name='meta_column_ids']" do
          check column2.name
          check I18n.t("gws/tabular.options.column.updated_or_deleted")
        end
      ...
      Gws::Tabular::View::Base.all.first.tap do |view|
        ...
        # Gws::Addon::Tabular::ListView
        expect(view.title_columns.count).to eq 1
        expect(view.title_column_ids.count).to eq 1
        expect(view.title_column_ids).to include(column1.id.to_s)
        expect(view.meta_columns.count).to eq 1
        expect(view.meta_column_ids.count).to eq 2
        expect(view.meta_column_ids).to include(column2.id.to_s, "updated_or_deleted")
        ...
        # Common
        expect(view).to be_a(Gws::Tabular::View::List)
