...
describe Gws::Tabular::SpacesController, type: :feature, dbscope: :example, js: true do
  ...
  let!(:space1) { create :gws_tabular_space, cur_site: site, cur_user: admin, state: "public" }
  let!(:space2) { create :gws_tabular_space, cur_site: site, cur_user: admin, state: "public" }
