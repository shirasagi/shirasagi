...
describe Gws::Tabular::FilesController, type: :feature, dbscope: :example, js: true do
  ...
  let!(:column2) do
    create(
      :gws_tabular_column_enum_field, cur_site: site, cur_form: form, order: 20, required: "required",
      select_options: Array.new(3) { "select-#{unique_id}" },
      input_type: input_type, index_state: "none")
  end
  ...
  context "crud with enum column" do
    ...
    let(:column2_label1) { column2_value1 }
    ...
    context "with radio" do
      ...
      it do
        ...
        within "form#item-form" do
          ...
          choose column2_label1, exact: true, match: :first
        ...
        Gws::Tabular::File[form.current_release].tap do |file_model|
          ...
          file_model.all.first.tap do |file|
            ...
            expect(file.read_tabular_value(column2)).to eq [ column2_value1 ]
          end
        end
    ...
    context "with checkbox" do
      ...
      it do
        ...
        within "form#item-form" do
          fill_in "item[col_#{column1.id}]", with: column1_value1
          check column2_label1, exact: true, match: :first
    ...
    context "with select" do
      ...
      it do
        ...
        within "form#item-form" do
          fill_in "item[col_#{column1.id}]", with: column1_value1
          select column2_label1, from: "item[col_#{column2.id}][]"
