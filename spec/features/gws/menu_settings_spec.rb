  ...
  context "with auth" do
    ...
    context "basic" do
      it do
        ...
        expect(page).to have_css("span.ss-icon.ss-icon-daily_report")
        ...
        expect(page).to have_css("span.ss-icon.ss-icon-shared_address")
        expect(page).to have_css("span.ss-icon.ss-icon-personal_address")
