...
describe "gws_affair2_leave_achieve", type: :feature, dbscope: :example, js: true do
  ...
  context "denied with no attendance setting" do
    ...
    it "#index" do
      visit gws_affair2_leave_achieve_index_path(site, site, year_month)
  ...
  context "basic" do
    context "manager user" do
      ...
      it "#index" do
        visit gws_affair2_leave_achieve_index_path(site, affair2.groups.g1_1, year_month)
        wait_for_js_ready
        ...
        within ".gws-attendance" do
          ...
          within "table.index tbody" do
            ...
            expect(page).to have_link user.long_name
            expect(page).to have_link affair2.users.u12.long_name
          end

          within ".nav-menu" do
            select affair2.groups.g1_1_1.name, from: "group"
          end
          expect(current_path).to eq gws_affair2_leave_achieve_index_path(site, affair2.groups.g1_1_1, year_month)
          wait_for_js_ready
          ...
          expect(current_path).to eq gws_affair2_leave_achieve_index_path(site, affair2.groups.g1_1_2, year_month)
          wait_for_js_ready

          within "table.index tbody" do
            expect(page).to have_selector("tr", count: 2)
            expect(page).to have_link affair2.users.u5.long_name
            expect(page).to have_link affair2.users.u6.long_name
          end
        end
      end

      it "#show" do
        visit gws_affair2_leave_achieve_path(site, affair2.groups.g1_1, year_month, user.id)
        wait_for_js_ready
        ...
        visit gws_affair2_leave_achieve_path(site, affair2.groups.g1_1, year_month, affair2.users.u12.id)
        wait_for_js_ready
    ...
    context "manager user" do
      ...
      it "#index" do
        ...
        within ".gws-attendance" do
          ...
          within "table.index tbody" do
            expect(page).to have_selector("tr", count: 2)
            expect(page).to have_link affair2.users.u2.long_name
            expect(page).to have_link affair2.users.u12.long_name
          end
          ...
          expect(current_path).to eq gws_affair2_leave_achieve_index_path(site, affair2.groups.g1_2, year_month)
          wait_for_js_ready

          within "table.index tbody" do
            expect(page).to have_selector("tr", count: 2)
            expect(page).to have_link affair2.users.u7.long_name
            expect(page).to have_link affair2.users.u12.long_name
          end
        end
      end
    ...
    context "regular user" do
      ...
      it "#index" do
        visit gws_affair2_leave_achieve_index_path(site, affair2.groups.g1_1_1, year_month)
        wait_for_js_ready
      ...
      it "#show" do
        visit gws_affair2_leave_achieve_path(site, affair2.groups.g1_1_1, year_month, user.id)
        wait_for_js_ready
        ...
        visit gws_affair2_leave_achieve_path(site, affair2.groups.g1_1_1, year_month, affair2.users.u4.id)
        wait_for_js_ready
