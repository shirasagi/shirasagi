        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "7:00")
              expect(page).to have_css(".over_break_time", text: "7:00")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "14:00")
              expect(page).to have_css(".over_break_time", text: "14:00")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "0:30")
              expect(page).to have_css(".over_break_time", text: "0:30")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "11:00")
              expect(page).to have_css(".over_break_time", text: "11:00")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "8:30")
              expect(page).to have_css(".over_break_time", text: "8:30")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "7:25")
              expect(page).to have_css(".over_break_time", text: "7:25")
            end
          end
        end
      end
        ...
        Timecop.travel(month) do
          ...
          within ".attendance-box.monthly" do
            within ".day-4" do
              expect(page).to have_css(".break_minutes", text: "--:--")
              expect(page).to have_css(".work_time", text: "0:00")
              expect(page).to have_css(".over_time", text: "15:00")
              expect(page).to have_css(".over_break_time", text: "15:00")
            end
          end
        end
      end
