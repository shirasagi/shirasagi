...
describe "gws_affair2_overtime_achieve", type: :feature, dbscope: :example, js: true do
  let!(:site) { gws_site }
  let!(:user) { gws_user }
  ...
  context "denied with no attendance setting" do
    ...
    it "#index" do
      visit gws_affair2_overtime_achieve_index_path(site, site, year_month)
  ...
  context "basic" do
    context "manager user" do
      ...
      it "#index" do
        visit gws_affair2_overtime_achieve_index_path(site, affair2.groups.g1_1, year_month)
        wait_for_js_ready
        ...
        within ".gws-attendance" do
          ...
          expect(current_path).to eq gws_affair2_overtime_achieve_index_path(site, affair2.groups.g1_1_1, year_month)
          wait_for_js_ready
          ...
          expect(current_path).to eq gws_affair2_overtime_achieve_index_path(site, affair2.groups.g1_1_2, year_month)
          wait_for_js_ready
    ...
    context "manager user" do
      ...
      it "#index" do
        ...
        within ".gws-attendance" do
          ...
          expect(current_path).to eq gws_affair2_overtime_achieve_index_path(site, affair2.groups.g1_2, year_month)
          wait_for_js_ready
    ...
    context "regular user" do
      ...
      it "#index" do
        visit gws_affair2_overtime_achieve_index_path(site, affair2.groups.g1_1_1, year_month)
        within ".gws-attendance" do
          within ".nav-menu" do
