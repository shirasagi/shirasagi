  ...
  context "denied with no attendance setting" do
    ...
    it "#index" do
      Timecop.travel(month) do
        ...
        visit gws_affair2_overtime_workday_files_path site
    ...
    context "regular user" do
      ...
      it "#edit" do
        Timecop.travel(month) do
          ...
          visit edit_gws_affair2_overtime_workday_file_path(site, item)
          within "form#item-form" do
           click_button I18n.t('ss.buttons.save')
          end
          wait_for_notice I18n.t("ss.notice.saved")
      ...
      it "#delete" do
        Timecop.travel(month) do
          ...
          visit delete_gws_affair2_overtime_workday_file_path(site, item)
          within "form#item-form" do
