  ...
  context "with folder crud on folder navi" do
    it do
      ...
      within "#gws-share-file-folder-list" do
        first(".btn-create-root-folder").click
      end
      within "#cboxLoadedContent #item-form" do
