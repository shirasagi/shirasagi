...
describe "gws_faq_categories", type: :feature, dbscope: :example, js: true do
  ...
  context "delete parent" do
    let!(:category0) { create :gws_faq_category, cur_site: site }
    let!(:category1) { create :gws_faq_category, cur_site: site, name: "#{category0.name}/#{unique_id}" }
    ...
    it do
      ...
      wait_for_error I18n.t("mongoid.errors.models.gws/faq/category.found_children")
    end
  end
end
