...
describe "gws_workflow2_form_applications", type: :feature, dbscope: :example, js: true do
  ...
  let!(:role) do
    permissions = %w(
      use_gws_workflow
      read_private_gws_workflow_forms edit_private_gws_workflow_forms delete_private_gws_workflow_forms
      read_private_gws_workflow_routes edit_private_gws_workflow_routes delete_private_gws_workflow_routes
    )
  ...
  it do
    ...
    expect(form.i18n_name_translations[I18n.default_locale]).to eq name
