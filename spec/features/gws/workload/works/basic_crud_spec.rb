...
describe "gws_workload_works", type: :feature, dbscope: :example, js: true do
  let(:site) { gws_site }
  let(:index_path) { gws_workload_works_path site }
  let(:new_path) { new_gws_workload_work_path site }
  let(:show_path) { gws_workload_work_path site, item }
  let(:edit_path) { edit_gws_workload_work_path site, item }
  let(:delete_path) { soft_delete_gws_workload_work_path site, item }
