...
describe "contact/agents/addons/page/view/index.html.erb", type: :feature, dbscope: :example do
  ...
  context "when page's contact_state is 'show'" do
          ...
          contact_groups: [
            {
              ...
              contact_tel: nil, contact_fax: nil, contact_email: nil, contact_postal_code: nil, contact_address: nil,
          ...
          contact_groups: [
            {
              ...
              contact_tel: unique_tel, contact_fax: nil, contact_email: nil, contact_postal_code: nil, contact_address: nil,
              contact_link_url: nil, contact_link_name: nil,
              main_state: "main"
            }
          ]
      ...
      let!(:group) do
        create(
          ...
          contact_groups: [
            {
              name: "name-#{unique_id}", contact_group_name: nil, contact_charge: nil,
              contact_tel: nil, contact_fax: unique_tel, contact_email: nil, contact_postal_code: nil, contact_address: nil,
              contact_link_url: nil, contact_link_name: nil,
              main_state: "main"
            }
          ]
      ...
      let!(:group) do
        create(
          ...
          contact_groups: [
            {
              name: "name-#{unique_id}", contact_group_name: nil, contact_charge: nil,
              contact_tel: nil, contact_fax: nil, contact_email: unique_email, contact_postal_code: nil, contact_address: nil,
              contact_link_url: nil, contact_link_name: nil,
              main_state: "main"
            }
          ]
    ...
    context "when only contact_postal_code is given" do
      let!(:group) do
        create(
          :contact_group, name: "#{group0.name}/#{unique_id}",
          contact_groups: [
            {
              name: "name-#{unique_id}", contact_group_name: nil, contact_charge: nil,
              contact_tel: nil, contact_fax: nil, contact_email: nil, contact_postal_code: unique_id, contact_address: nil,
              contact_link_url: nil, contact_link_name: nil,
              main_state: "main"
            }
          ]
      ...
      it do
        visit article.full_url
        # 郵便番号だけを表示しても意味がない。住所がない場合、郵便番号は表示されない。
        # この結果、表示項目数が1個となり、全体的に非表示となる。
        expect(page).to have_no_css("footer.contact")
      end
    end

    context "when only contact_address is given" do
      let!(:group) do
        create(
          :contact_group, name: "#{group0.name}/#{unique_id}",
          contact_groups: [
            {
              ...
              contact_postal_code: nil, contact_address: "address-#{unique_id}", contact_link_url: nil, contact_link_name: nil,
              main_state: "main"
            }
          ]
        )
      ...
      it do
        ...
        within "footer.contact" do
          ...
          expect(page).to have_css(".group", text: group.section_name)
          # グループに設定した住所が表示される
          expect(page).to have_css(".address-group .address", text: main_contact.contact_address)
        end
      end
    end
