...
describe "webmail_groups", type: :feature, dbscope: :example, js: true do
  ...
  context "import accounts_2-1.csv" do
    it do
      ...
      perform_enqueued_jobs do
        within "form" do
          attach_file "item[in_file]", "#{Rails.root}/spec/fixtures/webmail/group_importer/accounts_2-1.csv"
  ...
  context "import accounts_2-1.csv and overwrite with accounts_2-2.csv" do
    it do
      visit webmail_groups_path
      within ".nav-menu" do
        click_on I18n.t("ss.links.import")
      ...
      perform_enqueued_jobs do
        within "form" do
          attach_file "item[in_file]", "#{Rails.root}/spec/fixtures/webmail/group_importer/accounts_2-2.csv"
          click_button I18n.t("ss.import")
        end
        wait_for_notice I18n.t('ss.notice.started_import')
      end
