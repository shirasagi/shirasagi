...
describe "facility_images" do
  ...
  subject(:trash_path) { trash_facility_images_path site.id, node }
  ...
  subject(:soft_delete_path) { soft_delete_facility_image_path site.id, node, item }
  subject(:undo_delete_path) { undo_delete_facility_image_path site.id, node, item }
