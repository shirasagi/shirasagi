...
describe "workflow_branch", type: :feature, dbscope: :example, js: true do
  ...
  context "cms page" do
    let(:item) { create_once :cms_page, filename: "page.html", name: old_name, index_name: old_index_name }
    let(:show_path) { cms_page_path site, item }
    it { create_branch }
  end

  context "article page" do
    let(:item) { create_once :article_page, filename: "docs/page.html", name: old_name, index_name: old_index_name }
  ...
  context "event page" do
    let(:item) { create_once :event_page, filename: "event/page.html", name: old_name, index_name: old_index_name }
  ...
  context "faq page" do
    let(:item) { create_once :faq_page, filename: "faq/page.html", name: old_name, index_name: old_index_name }
  ...
  context "mail_page page" do
    let(:item) { create_once :mail_page_page, filename: "mail/page.html", name: old_name, index_name: old_index_name }
  ...
  context "sitemap page" do
    let(:item) { create_once :sitemap_page, filename: "sitemap/page.html", name: old_name, index_name: old_index_name }
