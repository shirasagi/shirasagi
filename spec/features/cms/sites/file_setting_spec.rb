...
describe "cms_sites", type: :feature, dbscope: :example, js: true do
  ...
  context "resizing is under min" do
    let(:resizing_width) { 100 }
    let(:resizing_height) { 100 }
    ...
    it do
      ...
      site.reload
      expect(site.file_resizing).to eq [ Cms::Site::MIN_FILE_RESIZING, Cms::Site::MIN_FILE_RESIZING ]
    end
  end

  context "resizing is negative" do
    let(:resizing_width) { -100 }
    let(:resizing_height) { -100 }
  ...
  context "resizing is over max" do
    let(:resizing_width) { 6_000 }
    let(:resizing_height) { 6_000 }
    ...
    it do
      ...
      site.reload
      expect(site.file_resizing).to eq [ Cms::Site::MAX_FILE_RESIZING, Cms::Site::MAX_FILE_RESIZING ]
    end
  end
end
