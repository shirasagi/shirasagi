...
describe "cms_nodes" do
  ...
  subject(:trash_path) { trash_cms_nodes_path site.id }
  ...
  subject(:soft_delete_path) { soft_delete_cms_node_path site.id, item }
  subject(:undo_delete_path) { undo_delete_cms_node_path site.id, item }
