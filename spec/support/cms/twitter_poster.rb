def capture_twitter_rest_client(tweet_id: nil, username: nil)
  ...
  WebMock.stub_request(:post, "https://api.x.com/2/tweets").to_return do |request|
  ...
  url = Addressable::Template.new("https://api.x.com/2/tweets/{id}")
  ...
  WebMock.stub_request(:get, "https://api.x.com/2/users/me").to_return do |request|
