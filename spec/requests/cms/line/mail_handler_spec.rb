...
describe "Cms::Agents::Nodes::LineHubController", type: :request, dbscope: :example do
  ...
  context "public" do
    ...
    context "from conditions unmatched" do
      ...
      it "#mail" do
        expect { post url, params: { data: data } }.to raise_error "from conditions unmatched"
      end
    end
    ...
    context "to conditions unmatched" do
      ...
      it "#mail" do
        expect { post url, params: { data: data } }.to raise_error "to conditions unmatched"
      end
    end
  end
end
