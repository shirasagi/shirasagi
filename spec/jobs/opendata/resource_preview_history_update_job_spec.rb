...
describe Opendata::ResourcePreviewHistoryUpdateJob, dbscope: :example do
  let(:site) { cms_site }
  ...
  let(:item) do
    create(:opendata_resource_preview_history_invalid, cur_site: site, dataset_id: dataset.id, resource_id: resource.id)
  end
