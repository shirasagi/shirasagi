...
describe Opendata::ResourcePreviewHistoryArchiveJob, dbscope: :example do
  let(:site) { cms_site }
  ...
  describe '#perform' do
    context 'usual case' do
      ...
      before do
        Timecop.freeze(threshold_day - 1.second) do
          create(:opendata_resource_preview_history, cur_site: site, previewed: threshold_day - 1.second)
        end
        Timecop.freeze(threshold_day) do
          create(:opendata_resource_preview_history, cur_site: site, previewed: threshold_day)
        end
        Timecop.freeze(threshold_day + 1.second) do
          create(:opendata_resource_preview_history, cur_site: site, previewed: threshold_day + 1.second)
        end
      ...
      it do
        ...
        Opendata::ResourcePreviewHistory::ArchiveFile.site(site).first.tap do |archive_file|
          ...
          expect(archive_file.name).to eq '2017年10月15日ー2017年10月21日.zip'
    ...
    context '年をまたぐ場合' do
      ...
      before do
        # sunday
        Timecop.freeze('2015-12-27T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # monday
        Timecop.freeze('2015-12-28T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # tuesday
        Timecop.freeze('2015-12-29T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # wednesday
        Timecop.freeze('2015-12-30T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # thursday
        Timecop.freeze('2015-12-31T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # friday
        Timecop.freeze('2016-01-01T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # saturday
        Timecop.freeze('2016-01-02T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
        # sunday
        Timecop.freeze('2016-01-03T12:00:00+09:00') { create(:opendata_resource_preview_history, cur_site: site) }
      end

      it do
        expect(Opendata::ResourcePreviewHistory.site(site).count).to eq 8
        Timecop.freeze(now) do
          described_class.bind(site_id: site).perform_now
        end
        expect(Opendata::ResourcePreviewHistory.site(site).count).to eq 1
