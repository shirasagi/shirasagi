...
describe Gws::Ldap::SyncJob, dbscope: :example, ldap: true do
  ...
  context "simply import groups / users on site1" do
    it do
      expect { ss_perform_now described_class.bind(site_id: site1, task_id: task1) }.to output.to_stdout
  ...
  context "simply import groups / users on site2" do
    it do
      expect { ss_perform_now described_class.bind(site_id: site2, task_id: task2) }.to output.to_stdout
