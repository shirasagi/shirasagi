...
describe Gws::Elasticsearch::Indexer::WorkflowFormJob, dbscope: :example, es: true do
  ...
  describe '.callback' do
      ...
      it do
        ...
        perform_enqueued_jobs do
          expectation = expect do
            form = create(:gws_workflow_form, cur_site: site, cur_user: user)
          end
    ...
    context 'when model was updated' do
      let!(:form) do
        create(:gws_workflow_form, cur_site: site, cur_user: user)
      end
