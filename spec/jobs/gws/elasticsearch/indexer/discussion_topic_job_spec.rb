...
describe Gws::Elasticsearch::Indexer::DiscussionTopicJob, dbscope: :example, es: true do
  ...
  describe '.callback' do
    context 'when model was created' do
      let!(:forum) do
        create(:gws_discussion_forum, cur_site: site, cur_user: user, member_ids: [user.id])
      end
      ...
      it do
        ...
        perform_enqueued_jobs do
          expectation = expect do
            topic = create(:gws_discussion_topic, cur_site: site, cur_user: user, forum: forum, file_ids: [file.id])
          end
    ...
    context 'when model was updated' do
      ...
      let!(:topic) do
        create(:gws_discussion_topic, cur_site: site, cur_user: user, forum: forum, file_ids: [file.id])
      end
