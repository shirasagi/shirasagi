...
describe Gws::Tabular::File, type: :model, dbscope: :example do
  ...
  let!(:recycle_item_category_name_column) do
    create(
      :gws_tabular_column_lookup_field, cur_site: site, cur_form: recycle_item_form, order: 30, required: 'optional',
  ...
  describe "csv_item" do
    ...
    context "when reference_type is 'one_to_one'" do
      ...
      context "with actual value" do
        ...
        it do
          text = recycle_item1.read_csv_value(recycle_item_category_name_column)
