...
describe Gws::Memo::Category, type: :model, dbscope: :example do
  ...
  context "default params" do
    subject { create :gws_memo_category }
    it { expect(subject.errors.size).to eq 0 }
  end

  describe ".tree_sort" do
    before do
      create(:gws_memo_category, name: 'A')
      create(:gws_memo_category, name: 'A/AA', order: 100)
      create(:gws_memo_category, name: 'B')
      create(:gws_memo_category, name: 'B/BB')
    end
